...
_theme_section() {
    ...
    section_params=($(echo $command | tr "." " "))
    local section_name
    section_name=${section_params[1]}
    local section_prefix
    section_prefix=\${${section_params[2]:-'_null'}}
    local section_suffix
    section_suffix=\${${section_params[3]:-'_null'}}
